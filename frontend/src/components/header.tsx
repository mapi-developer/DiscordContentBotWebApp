    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-[#0b0f17]/70">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <nav className="flex items-center gap-2">
          <Link href="/auth/signup" className="rounded-lg px-3 py-2 text-sm font-semibold bg-white/10 hover:bg-white/15 border border-white/10 transition">
            Sign up
          </Link>
          <Link href="/auth/signin" className="rounded-lg px-3 py-2 text-sm font-semibold bg-[#7c9bff] hover:bg-[#6a85e0] text-black transition">
            Sign in
          </Link>
        </nav>
      </div>
